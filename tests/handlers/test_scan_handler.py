...
def test_handle_scan_success_no_extract_wait(mock_assert_process, mock_print_summary, mock_determine_scans, 
                                           mock_ensure_compatibility, mock_path_exists, mock_sleep, 
                                           mock_fetch_results, mock_assert_idle, mock_workbench, mock_params):
